...
package ada_main is
   ...
   u00078 : constant Version_32 := 16#8241d3e8#;
   pragma Export (C, u00078, "emergencyB");
   u00079 : constant Version_32 := 16#afbf07f4#;
   pragma Export (C, u00079, "emergencyS");
   u00080 : constant Version_32 := 16#7e180b3d#;
   pragma Export (C, u00080, "measuresS");
   u00081 : constant Version_32 := 16#f0df9003#;
   pragma Export (C, u00081, "system__img_realB");
   u00082 : constant Version_32 := 16#d7ab5015#;
   pragma Export (C, u00082, "system__img_realS");
   u00083 : constant Version_32 := 16#1494ba04#;
   ...
   u00085 : constant Version_32 := 16#f0ff42cb#;
   pragma Export (C, u00085, "system__float_controlS");
   u00086 : constant Version_32 := 16#f1f88835#;
   pragma Export (C, u00086, "system__img_lluB");
   u00087 : constant Version_32 := 16#c492a5f4#;
   pragma Export (C, u00087, "system__img_lluS");
   u00088 : constant Version_32 := 16#eef535cd#;
   pragma Export (C, u00088, "system__img_unsB");
   u00089 : constant Version_32 := 16#12af99c0#;
   pragma Export (C, u00089, "system__img_unsS");
   u00090 : constant Version_32 := 16#40736780#;
   pragma Export (C, u00090, "system__powten_tableS");
   u00091 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00091, "system__img_boolB");
   u00092 : constant Version_32 := 16#e5da701c#;
   ...
   u00094 : constant Version_32 := 16#f1daf268#;
   ...
   u00097 : constant Version_32 := 16#181dc502#;
   ...
   u00099 : constant Version_32 := 16#18d57884#;
   pragma Export (C, u00099, "system__img_biuB");
   u00100 : constant Version_32 := 16#4b792d7a#;
   pragma Export (C, u00100, "system__img_biuS");
   u00101 : constant Version_32 := 16#e7d8734f#;
   pragma Export (C, u00101, "system__img_llbB");
   u00102 : constant Version_32 := 16#0abe3d84#;
   pragma Export (C, u00102, "system__img_llbS");
   u00103 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00103, "system__img_lliB");
   u00104 : constant Version_32 := 16#014c5426#;
   pragma Export (C, u00104, "system__img_lliS");
   u00105 : constant Version_32 := 16#0e8808d4#;
   pragma Export (C, u00105, "system__img_llwB");
   u00106 : constant Version_32 := 16#a3d21e12#;
   pragma Export (C, u00106, "system__img_llwS");
   u00107 : constant Version_32 := 16#428b07f8#;
   pragma Export (C, u00107, "system__img_wiuB");
   u00108 : constant Version_32 := 16#2538aae8#;
   pragma Export (C, u00108, "system__img_wiuS");
   u00109 : constant Version_32 := 16#7ebd8839#;
   pragma Export (C, u00109, "system__val_intB");
   u00110 : constant Version_32 := 16#58a62bc8#;
   pragma Export (C, u00110, "system__val_intS");
   u00111 : constant Version_32 := 16#b44f9ae7#;
   pragma Export (C, u00111, "system__val_unsB");
   u00112 : constant Version_32 := 16#9df3480c#;
   pragma Export (C, u00112, "system__val_unsS");
   u00113 : constant Version_32 := 16#b3aa7b17#;
   pragma Export (C, u00113, "system__val_lliB");
   u00114 : constant Version_32 := 16#8a27e757#;
   pragma Export (C, u00114, "system__val_lliS");
   u00115 : constant Version_32 := 16#773383f5#;
   pragma Export (C, u00115, "fatbatexampleB");
   u00116 : constant Version_32 := 16#b3de2fd5#;
   pragma Export (C, u00116, "fatbatexampleS");
   u00117 : constant Version_32 := 16#9d39c675#;
   pragma Export (C, u00117, "system__memoryB");
   u00118 : constant Version_32 := 16#497e67c3#;
